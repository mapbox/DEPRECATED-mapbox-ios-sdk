...
### Map view ([`RMMapView`]({{site.baseurl}}/api/#RMMapView) class)
...
### Map view delegate ([`RMMapViewDelegate`]({{site.baseurl}}/api/#RMMapViewDelegate) protocol)
...
### Tile sources ([`RMTileSource`]({{site.baseurl}}/api/#RMTileSource) protocol)
...
### Markers & shapes ([`RMMapLayer`]({{site.baseurl}}/api/#RMMapLayer) and subclasses)

Markers and other visual additions above the map tile layers are managed with `RMMapLayer` and its subclasses:

 * [`RMMarker`]({{site.baseurl}}/api/#RMMarker) - points and images
 * [`RMShape`]({{site.baseurl}}/api/#RMShape) - vector lines and other custom shapes
 * [`RMCircle`]({{site.baseurl}}/api/#RMCircle) - perfect vector circles
...
### Embedded interactivity ([`RMInteractiveSource`]({{site.baseurl}}/api/#RMInteractiveSource) protocol)
...
### Tile caching ([`RMTileCache`]({{site.baseurl}}/api/#RMTileCache) class)
